...
Contributions are welcome. `go-ruby-puppet/puppet` is built to a small set of
...
The library is in [`github.com/go-ruby-puppet/puppet`](https://github.com/go-ruby-puppet/puppet).
This documentation site is in [`github.com/go-ruby-puppet/docs`](https://github.com/go-ruby-puppet/docs).
