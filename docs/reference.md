...
The public API lives at the module root (`github.com/go-ruby-puppet/puppet`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `puppet`, while the surface follows
...
```go
import "github.com/go-ruby-puppet/puppet"
```
...
- **[pkg.go.dev/github.com/go-ruby-puppet/puppet](https://pkg.go.dev/github.com/go-ruby-puppet/puppet)**

The module's [README](https://github.com/go-ruby-puppet/puppet#readme) carries worked
